...
public class RunClass {
	...
	static String  myOrder = "Inactive";
	static int Count;
		...
		loop:do {
			...
			if(!BossMessage.equals(lastMessage)){
				...
				//Camera captured photo send functionality 
					...
					break loop;
				}else if(lowerBossMsg.contains("manage orders")&&lowerBossMsg.contains("inactive")) {

					myOrder = "Inactive";
					Thread.sleep(500);
					Help.sendReply("Manage Order is Intivated");
					break loop;
				}
